...
class VariableResolver {
    ...
    resolveString(folderUri, value, customVariables) {
        let filePath = "";
        const tmpFilePath = this.getFilePath();
        if (tmpFilePath) {
                ...
                default: {
                    ...
                    switch (variable) {
                        ...
                        case "execPath":
                            ...
                            return match;
                        default:
                            if (variable in customVariables) {
                                return customVariables[variable](match);
                            }
                            return match;
                    }
                }
    ...
    getFolderUri(folderName) {
        const folder = (vscode.workspace.workspaceFolders ? vscode.workspace.workspaceFolders : []).filter((f) => f.name === folderName).pop();
